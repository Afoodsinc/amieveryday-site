...
- 2026-09-20 — added a restrained bilingual motion system across all eight page types: distinct six-second films for Home, Products, Product Detail, Recipes, Our Brand, Markets, Partners, and Contact; optimized desktop/mobile variants and posters; exact approved product overlays where packaging appears; accessible localized play/pause controls; reduced-motion support; and bounded product, category, and recipe micro-movement. The AI-altered child render was rejected in favor of the approved photograph so the face, hands, smile, and juice carton remain authentic.

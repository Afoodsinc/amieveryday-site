...
- Products now opens with a product-led visual hero and every one of the 29 catalogue cards has an accessible quick view. Recipes now opens with a food-led visual story, while recipe and ingredient links connect back into the range.
- The partner page now tells the 15-year global private-label story with sourced NIQ, PLMA, and Circana evidence: global spending share grew from 15% in 2009 to 22% in 2024, supported by European, U.S., Latin American, and loyalty evidence.
